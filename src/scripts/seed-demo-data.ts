...
const PRODUCT_ID = new mongoose.Types.ObjectId('6a477247fe6b8d23e56a1d0e');
const SELLER_ID   = new mongoose.Types.ObjectId('6a477021fe6b8d23e568b53e');
...
const ORDER_STATUSES: Array<'Placed' | 'Confirmed' | 'Packed' | 'Shipped' | 'Delivered' | 'Cancelled'> = [
  'Placed', 'Confirmed', 'Packed', 'Shipped', 'Delivered', 'Cancelled'
];

const PAYMENT_STATUSES: Array<'Pending' | 'Paid' | 'Failed'> = ['Pending', 'Paid', 'Failed'];
...
async function seedData() {
  ...
  // ---------- 1. SEED 500 USERS ----------
  console.log('\nSeeding 500 users...');
  await User.deleteMany({ email: /@demotest\.com$/ });
