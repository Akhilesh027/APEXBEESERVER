...
exports.getBusinessByPincode = void 0;
const Vendor_1 = require("../models/Vendor");
const getBusinessByPincode = async (req, res) => {
    try {
        ...
        const vendors = await Vendor_1.Vendor.find({ pincode: pin, status: "active" })
            .limit(limitNum);
...
exports.getBusinessByPincode = getBusinessByPincode;
