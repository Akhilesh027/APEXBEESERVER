...
const SearchDocumentSchema = new mongoose_1.Schema({
    entityType: {
        type: String,
        required: true,
        enum: [
...
exports.SearchDocument = mongoose_1.default.model('SearchDocument', SearchDocumentSchema);
exports.default = exports.SearchDocument;
