...
const DeliveryProofSchema = new mongoose_1.Schema({
    assignmentId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'DeliveryAssignment', required: true, unique: true, index: true },
    otpCode: { type: String },
...
exports.DeliveryProof = mongoose_1.default.model('DeliveryProof', DeliveryProofSchema);
