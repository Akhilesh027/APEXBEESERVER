...
const CategoryStatsSchema = new mongoose_1.Schema({
    categoryId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Category', required: true, unique: true },
...
exports.CategoryStats = mongoose_1.default.model('CategoryStats', CategoryStatsSchema);
exports.default = exports.CategoryStats;
