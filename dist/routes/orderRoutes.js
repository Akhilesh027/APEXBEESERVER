...
router.get("/", auth_1.protect, (0, auth_1.restrictTo)('admin', 'vendor', 'wholesaler', 'manufacturer', 'state_franchise', 'district_franchise', 'mandal_franchise', 'customer'), orderController_1.getOrders);
router.get("/first-order/:userId", auth_1.protect, orderController_1.getFirstOrderCheck);
