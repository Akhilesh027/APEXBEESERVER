...
router.get('/signature', auth_1.protect, (req, res) => {
    try {
        const folder = req.query.folder || 'apexbee/proofs';
        const credentials = cloudinaryUploadService_1.CloudinaryUploadService.generateSignature(folder);
