...
exports.seedNotificationTemplates = void 0;
...
const seedNotificationTemplates = async () => {
    try {
        ...
        for (const t of defaultTemplates) {
            const exists = await NotificationTemplate_1.NotificationTemplate.findOne({ eventCode: t.eventCode });
            if (!exists) {
                await NotificationTemplate_1.NotificationTemplate.create(t);
