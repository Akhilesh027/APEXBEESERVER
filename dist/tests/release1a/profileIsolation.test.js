...
exports.testProfileIsolation = testProfileIsolation;
const assert_1 = __importDefault(require("assert"));
async function testProfileIsolation(tokens, host, userIds) {
    ...
    assert_1.default.strictEqual(resRead.status, 404, "Vendor B should get 404 when reading Vendor A's profile");
    ...
    assert_1.default.strictEqual(resUpdate.status, 404, "Vendor B should get 404 when updating Vendor A's profile");
    ...
    assert_1.default.strictEqual(resCust.status, 404, "Customer should get 404 when updating Vendor A's profile");
    ...
    assert_1.default.strictEqual(resReqDoc.status, 403, "Non-admin requesting document should get 403 Forbidden");
